...
import { Upload, Download, ImagePlus, Trash2, ArrowRight } from 'lucide-react';
...
export const JpgToPng: React.FC = () => {
  ...
  const handleDownload = () => {
    ...
    downloadFile(convertedBlob, `${name}.png`, 'image/png');
  };
  ...
  return (
    <div id="jpg-to-png-component" className="space-y-6">
      {!file ? (
        <div
        ...
        >
          ...
          <div>
            <h3 className="text-sm font-semibold text-stone-900">
              Upload JPG/JPEG image to convert to PNG
            </h3>
            <p className="text-xs text-stone-500 mt-1">
              Lossless PNG conversion • 100% Client-side in browser
            </p>
          </div>
          <input
            ref={fileInputRef}
        ...
        <div className="space-y-6">
          <div className="p-4 bg-white rounded-xl border border-stone-200 shadow-2xs flex flex-wrap items-center justify-between gap-4">
              ...
              {dimensions && (
                <>
                  ...
                  <div>
                    ...
                    <span className="font-mono text-stone-700">{dimensions.w} × {dimensions.h}px</span>
                  </div>
                </>
              )}
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span>Download .PNG ({convertedBlob ? formatBytes(convertedBlob.size) : '...'})</span>
              </button>
          ...
          <div className="bg-white rounded-xl border border-stone-200 p-4 space-y-2 shadow-2xs">
            <div className="flex items-center justify-between text-xs font-semibold text-stone-700">
              <span>Converted PNG Preview</span>
              <span className="text-emerald-700 font-medium">Ready to download</span>
            </div>
